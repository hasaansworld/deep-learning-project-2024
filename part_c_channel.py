...
class ChannelAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Reshape attention weights to match input tensor dimensions
...
class MyModel(nn.Module):
    def __init__(self, num_classes=5, dropout_rate=0.5):
        ...
        # Add channel attention after the backbone
...
class MyDualModel(nn.Module):
    def __init__(self, num_classes=5, dropout_rate=0.5):
        ...
        # Add channel attention for both branches
...
if __name__ == '__main__':
    ...
    model = train_model(
        ...
        checkpoint_path='./results/part_c_channel.pth'
    )

    # Load the pretrained checkpoint
    state_dict = torch.load('./results/part_c_channel.pth', map_location='cpu')
    model.load_state_dict(state_dict, strict=True)

    # Make predictions on testing set and save the prediction results
    evaluate_model(model, test_loader, device, test_only=True, prediction_path="./results/test_prediction_c_channel.csv")
