...
if __name__ == '__main__':
    ...
    model = train_model(
        ...
        checkpoint_path='./results/part_a_double.pth'
    )

    # Load the pretrained checkpoint
    state_dict = torch.load('./results/part_a_double.pth', map_location='cpu')
    model.load_state_dict(state_dict, strict=True)

    # Make predictions on testing set and save the prediction results
    evaluate_model(model, test_loader, device, test_only=True, prediction_path="./results/test_prediction_a_double.csv")
